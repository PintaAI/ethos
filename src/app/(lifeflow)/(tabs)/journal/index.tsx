          ...
          <Stack.Toolbar.View hidesSharedBackground>
            {Platform.OS === "ios" ? (
              ...
              >
                ...
                >
                  <AppSymbol name="square.and.pencil" size={16} tintColor={appTheme.colors.background} fallback={<Text style={{ color: appTheme.colors.background }}>+</Text>} />
              ...
              >
                <AppSymbol name="square.and.pencil" size={16} tintColor={appTheme.colors.inverseForeground} fallback={<Text>+</Text>} />
